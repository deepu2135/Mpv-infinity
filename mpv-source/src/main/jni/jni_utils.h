...
UTIL_EXTERN jclass java_Integer, java_Long, java_Double, java_Float, java_Boolean;
UTIL_EXTERN jmethodID java_Integer_init, java_Integer_intValue;
UTIL_EXTERN jmethodID java_Long_init, java_Long_longValue;
UTIL_EXTERN jmethodID java_Double_init, java_Double_doubleValue;
UTIL_EXTERN jmethodID java_Float_init, java_Float_floatValue;
UTIL_EXTERN jmethodID java_Boolean_init, java_Boolean_booleanValue;
...
UTIL_EXTERN jclass mpv_MPVNode, mpv_MPVNode_None, mpv_MPVNode_StringNode,
    mpv_MPVNode_BooleanNode, mpv_MPVNode_IntNode, mpv_MPVNode_DoubleNode,
    mpv_MPVNode_ArrayNode, mpv_MPVNode_MapNode;
UTIL_EXTERN jfieldID mpv_MPVNode_None_INSTANCE;
UTIL_EXTERN jmethodID mpv_MPVNode_StringNode_init,
    mpv_MPVNode_BooleanNode_init,
    mpv_MPVNode_IntNode_init,
    mpv_MPVNode_DoubleNode_init,
    mpv_MPVNode_ArrayNode_init,
    mpv_MPVNode_MapNode_init;
