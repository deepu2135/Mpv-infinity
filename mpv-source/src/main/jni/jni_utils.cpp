...
void init_methods_cache(JNIEnv *env)
{
    ...
    java_Long_longValue = env->GetMethodID(java_Long, "longValue", "()J");
    ...
    java_Float = FIND_CLASS("java/lang/Float");
    java_Float_init = env->GetMethodID(java_Float, "<init>", "(F)V");
    java_Float_floatValue = env->GetMethodID(java_Float, "floatValue", "()F");
    ...
    android_graphics_Bitmap_createBitmap = env->GetStaticMethodID(
        android_graphics_Bitmap, "createBitmap",
        "([IIILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;");
    android_graphics_Bitmap_Config = FIND_CLASS("android/graphics/Bitmap$Config");
    android_graphics_Bitmap_Config_ARGB_8888 = env->GetStaticFieldID(
    ...
    mpv_MPVLib_eventProperty_SN = env->GetStaticMethodID(
        mpv_MPVLib, "eventProperty", "(Ljava/lang/String;Lis/xyz/mpv/MPVNode;)V");
    mpv_MPVLib_event = env->GetStaticMethodID(mpv_MPVLib, "event", "(I)V");
    mpv_MPVLib_event_N = env->GetStaticMethodID(
        mpv_MPVLib, "event", "(ILis/xyz/mpv/MPVNode;)V");
    mpv_MPVLib_efEvent = env->GetStaticMethodID(
        mpv_MPVLib, "efEvent", "(Ljava/lang/String;)V");
    ...
    mpv_MPVNode_None_INSTANCE = env->GetStaticFieldID(
        mpv_MPVNode_None, "INSTANCE", "Lis/xyz/mpv/MPVNode$None;");
    mpv_MPVNode_StringNode = FIND_CLASS("is/xyz/mpv/MPVNode$StringNode");
    mpv_MPVNode_StringNode_init = env->GetMethodID(
        mpv_MPVNode_StringNode, "<init>", "(Ljava/lang/String;)V");
    mpv_MPVNode_BooleanNode = FIND_CLASS("is/xyz/mpv/MPVNode$BooleanNode");
    mpv_MPVNode_BooleanNode_init = env->GetMethodID(
        mpv_MPVNode_BooleanNode, "<init>", "(Z)V");
    mpv_MPVNode_IntNode = FIND_CLASS("is/xyz/mpv/MPVNode$IntNode");
    mpv_MPVNode_IntNode_init = env->GetMethodID(
        mpv_MPVNode_IntNode, "<init>", "(J)V");
    mpv_MPVNode_DoubleNode = FIND_CLASS("is/xyz/mpv/MPVNode$DoubleNode");
    mpv_MPVNode_DoubleNode_init = env->GetMethodID(
        mpv_MPVNode_DoubleNode, "<init>", "(D)V");
    mpv_MPVNode_ArrayNode = FIND_CLASS("is/xyz/mpv/MPVNode$ArrayNode");
    mpv_MPVNode_ArrayNode_init = env->GetMethodID(
        mpv_MPVNode_ArrayNode, "<init>", "([Lis/xyz/mpv/MPVNode;)V");
    mpv_MPVNode_MapNode = FIND_CLASS("is/xyz/mpv/MPVNode$MapNode");
    mpv_MPVNode_MapNode_init = env->GetMethodID(
        mpv_MPVNode_MapNode, "<init>", "(Ljava/util/Map;)V");
    ...
    java_util_HashMap_put = env->GetMethodID(
        java_util_HashMap, "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
    #undef FIND_CLASS
